    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                # If the next position is a corner and not yet visited, add it to the visited corners
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    # List of corners that have not been visited
    ...
    # select the closest unvisited corner, update heuristic then check the next closest corner etc
    while unvisited_corners:
        distances = [(manhattan_distance(current_pos, corner), corner) for corner in unvisited_corners]
...
def foodHeuristic(state, problem):
    ...
    # Compute the maximum distance to the farthest food
    maxDistance = max(manhattanDistance(pacmanPosition, food) for food in foodList)
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState: pacman.GameState):
        ...
        gameState.
        """
        # Create an instance of AnyFoodSearchProblem with the current gameState
