...
class ConfigHandler:
    ...
    def __init__(self, target_obj, options, ignore_option_errors=False):
        ...
        for section_name, section_options in list(options.items()):
    ...
    def _parse_section_to_dict(cls, section_options, values_parser=None):
        ...
        for key, (_, val) in list(section_options.items()):
    ...
    def parse_section(self, section_options):
        ...
        :param dict section_options:
        """
        for (name, (_, value)) in list(section_options.items()):
            try:
                self[name] = value
    ...
    def parse(self):
        ...
        """
        for section_name, section_options in list(self.sections.items()):
...
class ConfigOptionsHandler(ConfigHandler):
    ...
    def _parse_cmdclass(self, value):
        ...
        return {k: resolve_class(v) for k, v in list(self._parse_dict(value).items())}
    ...
    def parse_section_packages__find(self, section_options):
        ...
        find_kwargs = dict(
            [(k, v) for k, v in list(section_data.items()) if k in valid_keys and v]
        )
    ...
    def parse_section_data_files(self, section_options):
        ...
        self['data_files'] = [(k, v) for k, v in list(parsed.items())]
