...
class InstallCommand(RequirementCommand):
    ...
    def run(self, options: Values, args: List[str]) -> int:
        ...
        try:
            ...
            reqs_to_build = [
                r
                for r in list(requirement_set.requirements.values())
...
def reject_location_related_install_options(
    ...
    for requirement in requirements:
        ...
        if location_options:
            offenders.append(
                "{!r} from {}".format(
                    format_options(list(location_options.keys())), requirement
                )
            )
    ...
    if options:
        ...
        if location_options:
            offenders.append(
                "{!r} from command line".format(format_options(list(location_options.keys())))
            )
