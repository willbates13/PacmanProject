...
class Link(KeyBasedCompareMixin):
    ...
    def as_hashes(self) -> Hashes:
        return Hashes({k: [v] for k, v in list(self._hashes.items())})

    @property
    def hash(self) -> Optional[str]:
        return next(iter(list(self._hashes.values())), None)
    ...
    def is_hash_allowed(self, hashes: Optional[Hashes]) -> bool:
        ...
        if hashes is None:
            return False
        return any(hashes.is_hash_allowed(k, v) for k, v in list(self._hashes.items()))
