...
class Resolution(object):
    ...
    def _backtrack(self):
        ...
        while len(self._states) >= 3:
            ...
            incompatibilities_from_broken = [
                ...
                for k, v in list(broken_state.criteria.items())
            ]
    ...
    def resolve(self, requirements, max_rounds):
        ...
        for round_index in range(max_rounds):
            ...
            unsatisfied_names = [
                key
                for key, criterion in list(self.state.criteria.items())
...
def _build_result(state):
    ...
    all_keys = {id(v): k for k, v in list(mapping.items())}
    ...
    connected = {None}
    for key, criterion in list(state.criteria.items()):
    ...
    return Result(
        mapping={k: v for k, v in list(mapping.items()) if k in connected},
        graph=graph,
