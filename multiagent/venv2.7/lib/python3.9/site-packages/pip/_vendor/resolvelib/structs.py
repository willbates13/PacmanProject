...
class DirectedGraph(object):
    ...
    def copy(self):
        ...
        other._forwards = {k: set(v) for k, v in list(self._forwards.items())}
        other._backwards = {k: set(v) for k, v in list(self._backwards.items())}
        return other
    ...
    def iter_edges(self):
        for f, children in list(self._forwards.items()):
            for t in children:
                yield f, t
